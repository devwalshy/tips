        ...
        {BILL_DENOMINATIONS.map((denomination) => {
          ...
          return (
            <div
              ...
              className="rounded-2xl border border-border/60 bg-surface-subtle/60 p-4"
            >
                ...
                <div className="flex items-center justify-between gap-3">
                  <div className="flex items-center gap-2">
                    <button
                      ...
                      className={clsx(
                        ...
                        count === 0
                          ...
                          : "border-brand-forest text-brand-forest hover:bg-brand-forest/10",
                      )}
                      onClick={() =>
                        onBillCountChange(
                          denomination.value,
                    ...
                    <input
                      ...
                      className="h-10 w-20 rounded-full border border-border bg-surface px-3 text-center text-sm font-semibold text-text-default outline-none focus:border-brand-forest focus:ring-2 focus:ring-brand-forest/40"
                      aria-label={`Count of ${denomination.label}`}
                    />
                    <button
                      type="button"
                      className="flex h-9 w-9 items-center justify-center rounded-full border border-brand-forest text-brand-forest transition-colors hover:bg-brand-forest/10"
                      onClick={() =>
